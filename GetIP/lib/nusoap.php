...
class nusoap_base {
	...
	/**
	 * namespaces used in the current context, e.g.
	 ...
	 *
	 * @return integer level 0-9, where 0 turns off
	 * @access public
	 */
	 ...
	 *
	 * @return int level 0-9, where 0 turns off
	 * @access public
	 */
	 ...
	 *        	to serialize
	 * @param string $name
	 *        	(local part) of the XML element
	 * @param string $type
	 *        	schema type (local part) for the element
	 * @param string $name_ns
	 *        	for the name of the XML element
	 * @param string $type_ns
	 *        	for the type of the element
	 * @param array $attributes
	 *        	to serialize as name=>value pairs
	 * @param string $use
	 *        	"use" (encoded|literal)
	 * @param boolean $soapval
	 *        	is called from soapval.
	 * @return string serialized element, possibly with child elements
	 * @access public
	 */
...
class nusoap_fault extends nusoap_base {
	 ...
	 * @param mixed $faultdetail
	 *        	detail, typically a string or array of string
	 */
	 ...
	 * serialize a fault
	 *
	 * @return string serialization of the fault instance.
	 * @access public
	 */
	function serialize() {
		$ns_string = '';
...
class nusoap_xmlschema extends nusoap_base {
	 ...
	 * @param
	 *        	string	Element name
	 * @return string type name for an unnamed type
	 * @access private
	 */
	 ...
	 * PHP type is kind of a misnomer since it actually returns 'struct' for assoc.
	 * arrays
...
class soapval extends nusoap_base {
	 ...
	 *
	 * @param string $use
	 *        	The WSDL use value (encoded|literal)
...
class soap_transport_http extends nusoap_base {
	 ...
	 *
	 * @return string method to use (socket|curl|unknown)
	 * @access private
	 */
	function io_method() {
	 ...
	 * @param integer $response_timeout
	 ...
	 * @param string $data
	 *        	The string to check.
	 * @return s a skippable header was found.
	 * @access private
	 */
	 ...
	 * @param array $cookies
	 *        	cookies to send
	 * @return boolean if OK, false if problem
	 * @access private
	 */
...
class nusoap_server extends nusoap_base {
	 ...
	 *
	 * @param mixed $wsdl
	 *        	file path or URL (string), or wsdl instance (object)
	 * @access public
	 */
	 ...
	 * @param array $request
	 *        	of parameter values
	 * @return boolean the operation was found
	 * @access private
	 */
	 ...
	 * @param string $data
	 *        	data from client
	 * @return mixed of the message, decoded into a PHP type
	 * @access private
	 */
	 ...
	 * @param mixed $schemaTargetNamespace
...
class nusoap_client extends nusoap_base {
	 ...
	 *
	 * @param mixed $endpoint
	 *        	SOAP server or WSDL URL (string), or wsdl instance (object)
	 * @param mixed $wsdl
	 *        	optional, set to 'wsdl' or true if using WSDL
	 * @param string $proxyhost
	 *        	optional
	 * @param string $proxyport
	 *        	optional
	 ...
	 * @param mixed $params
	 *        	An array, associative or simple, of the parameters
	 ...
	 * @return mixed from SOAP call, normally an associative array mirroring the structure of the XML response, false for certain fatal errors
	 * @access public
	 */
